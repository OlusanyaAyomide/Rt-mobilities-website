      ...
      <div className="container relative z-10 mx-auto md:px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-sm font-bold text-white/80 tracking-wider uppercase mb-3">
            Daily Operational Remittance Simulator
          </h2>
          <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Estimate Your Potential Returns
          </h3>
          <p className="text-white/70 text-lg">
            This tool illustrates typical daily remittance ranges generated by different mobility assets under active operations. Figures shown represent operational cash flows before costs and are for illustration only.
          </p>
        </div>
